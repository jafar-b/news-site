...
<section class="text-indigo-900 py-20 lg:py-[120px] overflow-hidden relative z-10">
<button className='text-white m-4 mx-6 py-4 px-6 rounded bg-blue-700  hover:bg-blue-600' onClick={()=>{router.back()}}> ◀-- Go Back</button>
   <div class="container">
      <div class="flex flex-wrap lg:justify-between mx-4">
         <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
            <div class="max-w-[570px] mb-12 lg:mb-0">
               ...
               <p class="text-base text-body-color leading-relaxed mb-9 ml-6">
                 This is a demo news website made by Jafar as a frontend project. The data is fetched through Open News Api... Hope you like it.🧡
               </p>
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full">
                     ...
                     <p class="text-base text-body-color">
                        99 S.t Jomblo Park Pekanbaru 28292. India
                     </p>
                  </div>
               </div>
               <div class="flex mb-8 max-w-[370px] w-full">
               ...
               <div class="flex mb-8 max-w-[370px] w-full">
                  ...
                  <div class="w-full ">
                     <h4 class="font-bold text-light text-xl mb-1">
                        Email Address
                     </h4>
                     <p class="text-base text-body-color">beldarjafar@gmail.com</p>
                  </div>
               </div>
            </div>
         </div>
               ...
               <form>
                  ...
                  <div>
                     <button
                        ...
                        hover:bg-opacity-90
                        "
                        onClick={() => window.location = 'mailto:beldarjafar@gmail.com'}
                        >
                     Send Message
                     </button>
